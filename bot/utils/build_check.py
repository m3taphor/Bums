...
async def check_base_url(press_key=True):
    if settings.TRACK_BOT_UPDATES:
        ...
        if main_js_formats:
            last_actual_files = await get_versions('bums')
            ...
            for js in main_js_formats:
                if last_actual_js in js:
                    ...
                    sys.exit("Bot updates detected. Contact me to check if it's safe to continue: https://t.me/m3taphor")
            ...
            if press_key:
                input("No main js file found. Contact me to check if it's safe to continue: https://t.me/m3taphor"
                      "\nPress 'Enter' to stop the bot...")
            sys.exit("No main js file found. Contact me to check if it's safe to continue: https://t.me/m3taphor")
